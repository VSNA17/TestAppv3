...
public class NewItemCosmetics extends AppCompatActivity {
    ...
    private void savenote(){
        ...
        CollectionReference dbcosRef = FirebaseFirestore.getInstance().collection("users");
        dbcosRef.document(a).collection("cosRef").add(new Set_item(R.drawable.cosmetics,title,"Quantity available:",initialquantity));
