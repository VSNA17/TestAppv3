...
public class NewItemOthers extends AppCompatActivity {
    ...
    private void savenote(){
        ...
        CollectionReference dbothRef = FirebaseFirestore.getInstance().collection("users");
        dbothRef.document(a).collection("othRef").add(new Set_item(R.drawable.shopping,title,"Quantity available:",initialquantity));
