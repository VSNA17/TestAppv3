...
public class NewItemOthersGroceries extends AppCompatActivity {
    ...
    private void savenote(){
        ...
        CollectionReference dbothgroRef = FirebaseFirestore.getInstance().collection("users");
        dbothgroRef.document(a).collection("othgroRef").add(new Set_item(R.drawable.others,title,"Quantity available:",initialquantity));
